                                    ...
                                    <div className="owl-carousel about-us-carousel">
                                        ...
                                        <div className="item">
                                            <div className="ow-img">
                                                <a href="#"><img src="images/gallery/portrait/pic4.jpg" alt="" /></a>
                                            </div>
                                        </div>
                                        {/* COLUMNS 2 */}
                                        <div className="item">
                                            <div className="ow-img">
                                                <a href="#"><img src="images/gallery/portrait/pic5.jpg" alt="" /></a>
                                            </div>
                                        </div>
                                        {/* COLUMNS 3 */}
                                        <div className="item">
                                            <div className="owl-img">
                                                <a href="#"><img src="images/gallery/portrait/pic6.jpg" alt="" /></a>
                                            </div>
                                        </div>
                                        {/* COLUMNS 4 */}
                                        <div className="item">
                                            <div className="ow-img">
                                                <a href="#"><img src="images/gallery/portrait/pic7.jpg" alt="" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
